...
<div id="main-wrapper">
    ...
    <div class="jumbotron text-center">
        <div class="content">
            ...
            <p class="lead">Log-in to check your rebate.</p>
            <button type="button"onclick="document.getElementById('id01').style.display='block'" class="btn btn-default btn-sm"><span>LOGIN</span></button>
        </div>
        <div id="id01" class="modal">
            ...
            <form class="modal-content animate" action="login.php" method="POST">
              ...
              <div class="contnr text-center">
                ...
                <br>
                <button type="submit" class="btn btn-def btn-sm" value="login" name="login_user"><b><span>Login</span></b></button><br>
